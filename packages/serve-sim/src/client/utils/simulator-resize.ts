...
export const SIMULATOR_RESIZE_CHARGE_MS = 580;
export const SIMULATOR_RESIZE_CHARGE_EASE = "cubic-bezier(0, 0, 0.2, 1)";
export const SIMULATOR_RESIZE_DISCHARGE_MS = 440;
...
export const RESIZE_MAIN_STROKE: Record<ResizeVisualPhase, string> = {
  idle: "rgba(245,247,252,0.55)",
  hover: "rgba(248,250,255,0.7)",
  drag: "rgba(255,255,255,0.94)",
};
...
export const RESIZE_MAIN_OPACITY: Record<ResizeVisualPhase, [hi: number, lo: number]> = {
  idle: [0.74, 0.58],
  hover: [0.82, 0.68],
  drag: [1, 0.96],
};

export const RESIZE_INNER_OPACITY: Record<ResizeVisualPhase, number> = {
  idle: 0.4,
  hover: 0.5,
  drag: 0.85,
};

export const RESIZE_BLOOM: Record<ResizeVisualPhase, number> = {
  idle: 0,
  hover: 0.45,
  drag: 0.68,
};
...
/** SVG fragment ids generated by `useId()` contain colons; strip everything that's not URL-safe. */
export function sanitizeSvgFragmentId(raw: string): string {
